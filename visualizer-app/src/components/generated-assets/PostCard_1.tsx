      ...
      <div className="relative w-[1080px] h-[1350px] bg-white shadow-2xl rounded-lg overflow-hidden flex flex-col p-16 border-[12px] border-sage/10">
        ...
        <header className="mb-12 border-b-2 border-sand/30 pb-8 z-10">
          <h1 className="font-serif text-6xl text-earth-brown leading-tight mb-4">
            Tú en tu oficina. Tu perro llegando a Paws. Sin desvíos.
          </h1>
        ...
        <main className="flex-grow z-10">
          <p className="font-sans text-3xl text-earth-brown/80 leading-relaxed whitespace-pre-wrap">
            Tú en tu oficina. Tu perro llegando a Paws. Sin desvíos. Sin estrés. Sin culpa.<br /><br />Nuestro servicio de transporte puerta a puerta recoge a tu perro en casa y lo trae de regreso cuando tú digas.<br /><br />Tú no cambias tu rutina. Él no se queda solo.<br /><br />Así de simple.<br /><br />📍 Polanco, CDMX<br />📲 Reserva por WhatsApp → link en bio
          </p>
        </main>
